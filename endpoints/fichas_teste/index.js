const RPG_NAME = 'teste';
const TESTE_ROUTE = `/enviar-ficha-${RPG_NAME}`;
const ID_DO_GRUPO = process.env.ID_DO_GRUPO_LONDON || process.env.ID_DO_GRUPO || '120363424464690545@g.us';

function buildTesteMessage(data) {
...
module.exports = function registerTesteEndpoints(app, deps) {
    app.post(TESTE_ROUTE, async (req, res) => {
        const payload = getPayloadFromRequest(req);
        const message = buildTesteMessage(payload);
